    ...
    return (
        <>
            ...
            >
                ...
                <TextCircle
                    text={"you can buy photos you can't buy memories - "}
                />
            ...
            <Fade bottom>
                <p className="py-14 max-md:px-10 md:w-1/2 mx-auto font-primary text-xl md:text-3xl leading-8 lg:leading-10 text-center">
                    My name is Kuleshov Simon. I am a beginner photographer
                    living in Amsterdam. My photography and video career started
                    in 2020. Now, I am taking my hobby further and turning it
                    into a professional career. I{`'`}m in search of new people,
                    projects, and photoshoots to put my creativity and energy
                    into. Today, the main goal for me is not to stand still.
                </p>
            </Fade>
        </>
    );
